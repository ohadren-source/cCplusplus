...
## How to Contribute
All contributions are governed by covenant. Fork → propose terms → ratify.
Blind PRs without an Interpretation Object will be deferred by AIOS.
See CONTRIBUTING.md (coming in first commit).
